...
const products = [
  {
    ...
    stock: 15,
    images: [{ public_id: 'seed_iphone15', url: 'https://images.unsplash.com/photo-1696446701796-da61225697cc?q=80&w=1000' }],
    rating: 4.8,
    numReviews: 120,
  },
  {
    ...
    category: 'Electronics',
    stock: 10,
    images: [{ public_id: 'seed_macbook', url: 'https://images.unsplash.com/photo-1661961111184-112730500159?q=80&w=1000' }],
    rating: 4.9,
    numReviews: 85,
  },
  {
    ...
    category: 'Other',
    stock: 25,
    images: [{ public_id: 'seed_sony', url: 'https://images.unsplash.com/photo-1670057037130-9bb36f0607bd?q=80&w=1000' }],
    rating: 4.7,
    numReviews: 200,
  },
  {
    ...
    category: 'Clothing',
    stock: 40,
    images: [{ public_id: 'seed_nike', url: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=1000' }],
    rating: 4.5,
    numReviews: 150,
  },
  {
    ...
    category: 'Electronics',
    stock: 12,
    images: [{ public_id: 'seed_s23', url: 'https://images.unsplash.com/photo-1678911820864-e2c567c655d7?q=80&w=1000' }],
    rating: 4.8,
    numReviews: 95,
  },
  {
    ...
    category: 'Electronics',
    stock: 5,
    images: [{ public_id: 'seed_fuji', url: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=1000' }],
    rating: 4.9,
    numReviews: 45,
  },
  {
    ...
    category: 'Clothing',
    stock: 100,
    images: [{ public_id: 'seed_levis', url: 'https://images.unsplash.com/photo-1542272604-787c3835535d?q=80&w=1000' }],
    rating: 4.4,
    numReviews: 320,
  },
  {
    ...
    stock: 20,
    images: [{ public_id: 'seed_chair', url: 'https://images.unsplash.com/photo-1592078615290-033ee584e267?q=80&w=1000' }],
    rating: 4.6,
    numReviews: 78,
  },
  {
    ...
    category: 'Other',
    stock: 50,
    images: [{ public_id: 'seed_mouse', url: 'https://images.unsplash.com/photo-1625842268584-8f3bf9ff16a2?q=80&w=1000' }],
    rating: 4.9,
    numReviews: 500,
  },
  {
    ...
    category: 'Home & Garden',
    stock: 200,
    images: [{ public_id: 'seed_bottle', url: 'https://images.unsplash.com/photo-1602143399827-7fd1b681812a?q=80&w=1000' }],
    rating: 4.7,
    numReviews: 1200,
  }
];
